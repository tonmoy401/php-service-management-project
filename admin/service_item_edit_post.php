...
$update_query = "UPDATE service_item SET service_item_heading='$service_item_heading',
 service_item_detail='$service_item_detail' WHERE id=$id";
    ...
    if($uploaded_image_original_size <= 2000000){
        ...
        $allow_extension = array('jpg','JPG','jpeg','JPEG','png','PNG');
          if(in_array($image_extension,$allow_extension)){
            ...
            $get_image_location_query = "SELECT image_location FROM service_item WHERE id=$id";
            ...
            // $id_from_db = mysqli_insert_id($db_connect);
             ...
             $update_image_query = "UPDATE service_item SET image_location='$image_location' WHERE id= $id";
