<?php
    ...
    if(!isset($_SESSION['user_status'])){
     ...
     $get_query = "SELECT * FROM social_medias WHERE id = $id";
                ...
                <div class="card-body">
                    ...
                    <form action="social_media_edit_post.php" method="post">
                            <div class="mb-3">
                                ...
                                value="<?=$after_assoc['page_link']?>"required>
                            </div>
                            <div class="mb-3">
                                <label class="text-capitalize text-primary">social icon</label>
                                <input type="text" class="form-control" name="social_icon" id="social_icon" 
                                value="<?=$after_assoc['social_icon']?>"required>
                            </div>
