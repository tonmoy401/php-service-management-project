    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="login_post.php" method="post" class="sign-in-form">
          ...
          <form action="form-submit1.php" method="post" class="sign-up-form">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>New here ?</h3>
            <p>
              Join Us For More News and Get Conected With Us.You can be a part of our Family
            </p>
        ...
        <div class="panel right-panel">
          <div class="content">
            <h3>One of us ?</h3>
            <p>
              If you are one of Us.You can login and get updated news day to day.
